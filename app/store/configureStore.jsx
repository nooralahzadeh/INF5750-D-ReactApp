...
export var configure = (initialState = {}) => {
  ...
  var reducer = redux.combineReducers({
    ...
    showFirstModal:showFirstModalReducer,
    showSecondModal:showSecondModalReducer,
